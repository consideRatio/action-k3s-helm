...
- `k3s-channel`, `k3s-version`, or `k3s-commit`: Specify a K3s [release channel](https://update.k3s.io/v1-release/channels), [version](https://github.com/k3s-io/k3s/releases), or [commit](). Versions 1.20 and later are supported. Defaults to the stable channel.
